...
window.fixServerSync = function() {
    ...
    console.log('[Clipboard] Current preferences:', prefs);
    
    if (!prefs.selectedServerId) {
        console.log('[X] No selected server ID in preferences');
        return false;
    }
    ...
    if (!selectedServer) {
        console.log('[X] Server not found for ID:', prefs.selectedServerId);
        return false;
    }
