    ...
    <div className="smart-analytics">
      <div className="analytics-header">
        ...
        <div className="analytics-header-right">
          ...
          <button className="export-btn" onClick={exportData} disabled={exporting}>
            {exporting ? '[Wait] Exporting...' : '📥 Export Data'}
          </button>
        </div>
      </div>
      ...
      <div className="analytics-dashboard">
            ...
            {activeInsights.map((insight) => (
              <div key={insight.id} className={`insight-card ${insight.priority} ${insight.applied ? 'applied' : ''}`}>
                ...
                <div className="insight-actions">
                  ...
                  <button className="dismiss-btn" onClick={() => dismissInsight(insight.id)}>X</button>
                </div>
              </div>
            ))}
            ...
            <div className="prediction-card">
              ...
              <div className="prediction-value">
                ...
                <span className={`trend ${predictions.nextWeekUsage.trend}`}>
                  {predictions.nextWeekUsage.trend === 'up' ? '[Chart]' : '[Decrease]'} {predictions.nextWeekUsage.trend}
                </span>
              </div>
        ...
        <div className="kpi-section">
          <h4>[Chart] Key Performance Indicators</h4>
