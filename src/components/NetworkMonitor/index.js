  ...
  return (
    <div className="network-monitor">
            ...
            {alerts.map(alert => (
              <div key={alert.id} className={`alert-card ${alert.severity}`}>
                <span className="alert-icon">
                  {alert.type === 'critical' ? '[X]' : alert.type === 'warning' ? '⚠️' : '[i]'}
                </span>
      ...
      <div className="metrics-section">
        <h4>[Chart] Performance Metrics (Last 24h)</h4>
      ...
      <div className="history-section">
        <h4>[Decrease] Network History</h4>
      ...
      <div className="actions-section">
        ...
        <div className="actions-grid">
          ...
          <button className="action-btn">[Bell] Configure Alerts</button>
          <button className="action-btn">[Chart] View Full History</button>
        </div>
      </div>
    </div>
  );
