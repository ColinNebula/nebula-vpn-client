...
const DataUsageTracker = ({ isConnected, trafficData }) => {
  ...
  const [apps, setApps] = useState([
    ...
    { id: 2, name: 'Netflix', icon: '▶️', category: 'Streaming', upload: 12, download: 4521, total: 4533, limit: 5000, color: '#E50914' },
    { id: 3, name: 'Spotify', icon: '[Music]', category: 'Music', upload: 8, download: 876, total: 884, limit: null, color: '#1DB954' },
    { id: 4, name: 'Steam', icon: '🎮', category: 'Gaming', upload: 156, download: 3245, total: 3401, limit: 10000, color: '#171a21' },
    { id: 5, name: 'Zoom', icon: '[Video]', category: 'Communication', upload: 432, download: 234, total: 666, limit: null, color: '#2D8CFF' },
    { id: 6, name: 'YouTube', icon: '[TV]', category: 'Streaming', upload: 34, download: 2187, total: 2221, limit: null, color: '#FF0000' },
    ...
    { id: 12, name: 'Other', icon: '[Box]', category: 'Miscellaneous', upload: 234, download: 456, total: 690, limit: null, color: '#9E9E9E' }
  ]);
        ...
        <div className="modal-overlay" onClick={() => setShowLimitModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <button onClick={() => setShowLimitModal(false)} className="close-btn">X</button>
            </div>
