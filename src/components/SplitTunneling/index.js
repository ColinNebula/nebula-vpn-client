...
const SplitTunneling = ({ apps, onAppsChange, isConnected, enabled }) => {
  const [availableApps] = useState([
    ...
    { id: 'spotify', name: 'Spotify', icon: '[Music]', category: 'Media', description: 'Music streaming' },
    { id: 'netflix', name: 'Netflix', icon: '▶️', category: 'Media', description: 'Video streaming' },
    { id: 'zoom', name: 'Zoom', icon: '[Video]', category: 'Communication', description: 'Video conferencing' },
    { id: 'teams', name: 'Microsoft Teams', icon: '👥', category: 'Communication', description: 'Collaboration platform' },
    { id: 'torrent', name: 'BitTorrent', icon: '[Box]', category: 'File Sharing', description: 'P2P file sharing' },
