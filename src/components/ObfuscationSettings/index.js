...
const ObfuscationSettings = ({ isConnected = false }) => {
  ...
  const antiCensorshipLevels = [
    ...
    { id: 'moderate', name: 'Moderate', desc: 'Balanced protection and speed', icon: '⚠️' },
  ...
  const mimicOptions = [
    ...
    { value: 'video', name: 'Video Streaming', icon: '[TV]', pattern: 'Netflix/YouTube patterns' },
    { value: 'voip', name: 'VoIP/Video Call', icon: '[Phone]', pattern: 'Zoom/Teams patterns' },
      ...
      <div className="bypass-status-panel">
        <div className="bypass-header">
          ...
          <button className="test-btn" onClick={runBypassTests}
            ...
            {Object.values(bypassTests).some(v => v === 'testing') ? '[Wait] Testing...' : '▶ Run Tests'}
          </button>
        </div>
      ...
      {obfuscationEnabled && (
        <>
          ...
          <div className="advanced-options">
            ...
            <div className="option-item">
              <div className="option-info">
                <span className="option-icon">[Gift]</span>
                <div>
            ...
            <div className="option-item">
              <div className="option-info">
                <span className="option-icon">[Ruler]</span>
                <div>
            ...
            <div className="option-item">
              <div className="option-info">
                <span className="option-icon">[Privacy]</span>
                <div>
            ...
            <div className="option-item">
              <div className="option-info">
                <span className="option-icon">[Detective]</span>
                <div>
