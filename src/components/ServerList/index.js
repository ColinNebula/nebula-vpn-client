...
const ServerList = ({ servers, onSelect, selectedServer, isConnected, onRefresh, isRefreshing = false }) => {
  ...
  const getSpecialtyBadge = (specialty) => {
    switch (specialty) {
      ...
      case 'streaming':   return { label: 'Streaming',      icon: '▶️', color: '#e91e63' };
      ...
      <div className="server-list-header">
        <div className="server-list-title-row">
          ...
          <div className="view-toggle">
            ...
            <button className={`view-btn ${viewMode === 'list' ? 'active' : ''}`} onClick={() => setViewMode('list')} title="List view">[Menu]</button>
          </div>
        ...
        <div className="server-search-wrap">
          ...
          />
          {searchQuery && (
            <button className="search-clear-btn" onClick={() => setSearchQuery('')}>X</button>
          )}
        </div>
              ...
              <div className="server-details">
                ...
                <div className="server-stats-row">
                  ...
                  <div className="feature-indicators">
                    {server.streaming && <span className="feature-icon" title="Streaming">▶️</span>}
