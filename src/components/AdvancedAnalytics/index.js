...
const AdvancedAnalytics = () => {
  ...
  const reportTypes = [
    ...
    { id: 'compliance', name: '[Clipboard] Compliance Report', desc: 'Regulatory compliance status' }
  ];
    ...
    <div className="advanced-analytics">
      <div className="analytics-header">
        ...
        <div className="analytics-controls">
          ...
          <button className="export-btn">[Upload] Export Report</button>
        </div>
      </div>
            ...
            <div key={metric.id} className="metric-card">
              <div className="metric-header">
                ...
                <span className={`trend-indicator ${metric.trend}`}>
                  {metric.trend === 'up' ? '[Chart]' : '[Decrease]'} {metric.change}
                </span>
              </div>
      ...
      <div className="scheduled-reports">
        <h4>[Calendar] Scheduled Reports</h4>
