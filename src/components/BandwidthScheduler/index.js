...
const BandwidthScheduler = () => {
  ...
  const [appLimits, setAppLimits] = useState([
    ...
    { id: 3, app: 'Netflix', icon: '[TV]', downloadLimit: 80, uploadLimit: 2, enabled: true },
    { id: 4, app: 'Zoom', icon: '[Phone]', downloadLimit: 30, uploadLimit: 15, enabled: true },
    { id: 5, app: 'Spotify', icon: '[Music]', downloadLimit: 10, uploadLimit: 1, enabled: false },
  ]);
    ...
    <div className="bandwidth-scheduler">
      ...
      <div className="usage-overview">
        ...
        <div className="usage-grid">
          ...
          <div className="usage-card">
            <span className="usage-icon">[Chart]</span>
            <div className="usage-details">
      ...
      <div className="schedules-section">
        <div className="section-header">
          <h4>[Calendar] Time-based Schedules</h4>
          <button 
            className="add-schedule-btn"
            onClick={() => setShowAddSchedule(!showAddSchedule)}
          >
            {showAddSchedule ? 'X Cancel' : '+ Add Schedule'}
          </button>
        </div>
