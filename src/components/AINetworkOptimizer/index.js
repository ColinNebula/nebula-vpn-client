  ...
  return (
    <div className="ai-network-optimizer">
      <div className="optimizer-header">
        ...
        <div className="ai-controls">
          ...
          <button className="optimize-btn" onClick={triggerAIOptimization} disabled={!!optimizationFeedback}>
            {optimizationFeedback === 'analyzing' ? '[Wait] Analyzing...' : optimizationFeedback === 'complete' ? '✅ Done!' : '🚀 Optimize Now'}
          </button>
        </div>
      </div>
      ...
      <div className="predictive-analytics">
        <h4>[Crystal] Predictive Analytics</h4>
        <div className="predictions-grid">
          <div className="prediction-card">
            <div className="prediction-icon">[Chart]</div>
