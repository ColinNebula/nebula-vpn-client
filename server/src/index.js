...
const app = express();
const PORT = process.env.SERVER_PORT || 3001; // Use SERVER_PORT to avoid conflict with React PORT
...
app.listen(PORT, () => {
  ...
  logger.info(`[Note] Environment: ${process.env.NODE_ENV || 'development'}`);
